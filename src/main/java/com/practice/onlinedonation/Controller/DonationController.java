...
public class DonationController {
   ...
   /* @GetMapping("/public/donation/{userId}")
    ...
    @GetMapping("/public/donation/{userId}")
    public ResponseEntity<DonationDetailsByUserResponseDTO> getDonationByUserEntity(@PathVariable Long userId){

        DonationDetailsByUserResponseDTO ddByUser = donationService.getDonationByUserEntity(userId);
